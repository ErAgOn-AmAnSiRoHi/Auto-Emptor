...
setup(
    ...
    data_files=[
        ...
        # Path to the hyper market sdf file
        (os.path.join('share', package_name,'models/hyper_market/'), glob('./models/hyper_market/*')),
    ...
    zip_safe=True,
    maintainer='rakhilml',
    maintainer_email='rakhilml@todo.todo',
    ...
    entry_points={
        'console_scripts': [
          ...
          'camera_read = warehouse_robot_spawner_pkg.camera_read:main',
          'decode_qr = warehouse_robot_spawner_pkg.decode_qr:main'
        ],
    },
)
